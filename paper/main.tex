...
\iffalse % template instructions retained below for reference; remove when not needed
\section{Introduction}\label{sec:intro}
UAI 2026 papers have to be prepared using \LaTeX.
To start writing your paper, copy \texttt{uai2026-template.tex} and replace title, authorship, and content with your own.

The UAI 2026 paper style is based on a custom \textsf{uai2026} class.
...
\begin{figure}[!htb]
  \centering
  \includegraphics[width=\linewidth]{figures/mygraph.png}
  \caption{A simple example graph.}\label{fig:city}
\end{figure}
...
\fi % end of retained template instructions
